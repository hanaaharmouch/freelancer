						...
						<div class="col-md-10 text-right menu-1">
								...
								<li class="has-dropdown">
									...
									<ul class="dropdown">
										...
										<li><a href="index.jsp">Mes postulations</a></li>
										<li><a href="index.jsp">Mes projets</a></li>
										<li><a href="indexp.jsp">Mon profil</a></li>
										<li><a href="FreelancerHome.jsp">Mon profil</a></li>
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                				...
                				<h1 style="text-align:center;"> BIENVENUE ${sessionScope.user_session.prenom} ${sessionScope.user_session.nom}</h1>
                				<br />
                				<hr />
                				<br />
                           <h3 style="text-align:center;"> Pour terminer votre inscription ajoutez une photo sympa de vous</h3>
                                <br />
                				<hr />
                				<br />
                                <form action="${ pageContext.request.contextPath}/upload.php?id=${sessionScope.user_session.tel}" enctype="multipart/form-data" method="POST" >
                        ...
                        <div>
                            <button class="btn btn--radius-2 btn--red" name="action" type="submit" value="upload" >Telecharger</button>
                        </div>
                    </form>
                </div>
            </div>
