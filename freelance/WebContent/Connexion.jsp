			   			...
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					...
				   					<p><a href="login.jsp" class="btn btn-primary btn-lg btn-learn">Freelancer</a></p>
				   					<p><a href="loginp.jsp" class="btn btn-primary btn-lg btn-learn">Porteur de projet</a></p>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
