			...
			<div class="container">
				<div class="row">
					<div class="col-md-3 text-center animate-box">
						<div class="services">
							<a href="offres.php"><span class="icon">
								<i class="flaticon-books"></i>
							</span></a>
							<div class="desc">
								<h3>Dernières offres en Freelance</h3>
							</div>
						</div>
					</div>
					<div class="col-md-3 text-center animate-box">
						<div class="services">
							<a href="PostulationsFreelancer.php?id=${sessionScope.user_session.id}"><span class="icon">
					...
					<div class="col-md-3 text-center animate-box">
						<div class="services">
						<a href="ProjetsFreelancer.php?id=${sessionScope.user_session.id}">
							<span class="icon">
