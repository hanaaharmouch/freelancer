			   			...
			   			<div class="row">
				   			<div class="col-md-6 col-sm-12 col-md-offset-3 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>BIENVENUE ${sessionScope.user_session.nom}</h1>
					...
					<div >
						<div class="event-entry">
							<div class="desc">
								...
								<h5><span>Catégorie:</span> <span>${p.categorie}</span></h5>
								<p class="organizer"><span>Budget:</span> <span>${p.budget}</span></p>
								
							</div>
							<div class="location">
								<span class="icon"><i class="icon-map"></i></span>
								<td class='select1'><a class='button1' href="Postulationp?id=${p.id}&idp=${sessionScope.user_session.id}">Postulations</a></td>
			  					<td class='select1'><a class='button1' href="updateOffre.php?id=${p.id}&idp=${sessionScope.user_session.id}">Modifier</a></td>
			  					<td class='select1'><a class='button1' href="DeleteOffre.php?id=${p.id}">supprimer</a></td>
							</div>
						</div>
					</div>
