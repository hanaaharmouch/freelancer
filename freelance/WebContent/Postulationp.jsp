...
<!--===============================================================================================-->
	...
	<div id="page" style="background-image: url(images/blog-6.jpg)  ;">
		...
		<div class="colorlib-event">
			<div class="container">
			 <c:forEach items="${model.postulations}" var="p">
				
				
					<div >
						<div class="event-entry">
							<div class="desc">
								<h2><a href="event.html">${p.nomf} ${p.prenomf}</a></h2>
								<p class="meta"><span >Durée</span><span >${p.dure}</span></p>
								<h5>Motivation: <span>${p.motivation}</span></h5>
								<p class="organizer"><span>Budget:</span> <span>${p.budget}</span></p>
								
							</div>
							<div class="location">
								<span class="icon"><i class="icon-map"></i></span>
								<td class='select1'><a class='button1' href="profilf.php?id=${p.id_freelancer}">Profil</a></td>
              					<td class='select1'><a class='button1' href="validerPost.php?idpost=${p.id_postulation}&idoffre=${p.id_offre}&idf=${p.id_freelancer}&idporteur=${sessionScope.user_session.id}">Valider</a></td>
							</div>
						</div>
					</div>
