...
<!-- Icon css link -->
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="person_img">
                                <img src="images/${model.freelancer.tel}.png" alt="">
                                
                                
									<span onmouseover="starmark(this)" onclick="starmark(this)" id="1one" style="font-size:25px;cursor:pointer;"  class="fa fa-star checked"></span>
									<span onmouseover="starmark(this)" onclick="starmark(this)" id="2one"  style="font-size:25px;cursor:pointer;" class="fa fa-star "></span>
									<span onmouseover="starmark(this)" onclick="starmark(this)" id="3one"  style="font-size:25px;cursor:pointer;" class="fa fa-star "></span>
									<span onmouseover="starmark(this)" onclick="starmark(this)" id="4one"  style="font-size:25px;cursor:pointer;" class="fa fa-star"></span>
									<span onmouseover="starmark(this)" onclick="starmark(this)" id="5one"  style="font-size:25px;cursor:pointer;" class="fa fa-star"></span>
									<br/>
									
                                <form name="myform" action="Noter" onsubmit="ToForm()">
								<input type="hidden" name="ValeurNote" id="ValeurNote"/>
								<input type="hidden" name="idporteur" value="${sessionScope.user_session.id}"/>
								<input type="hidden" name="idfreelancer" value="${model.freelancer.id}"/>
								
								<input type="submit" value="Voote"/>
								</form>
                        ...
                        <div class="col-md-7">
                            <div class="row person_details">
                                <h3>Hi I'm <span  style="color: #08c5fe;">${model.freelancer.prenom} ${model.freelancer.nom}</span></h3>
                                
                                <p>My name is ${model.freelancer.prenom} ${model.freelancer.nom} .</p>
                                <div class="person_information">
                                    ...
                                    <ul>
                                        <li><a href="#">${model.freelancer.adresse} </a></li>
                                        <li><a href="#">${model.freelancer.tel} </a></li>
                                        <li><a href="#">${model.freelancer.mail} </a></li>
                                    </ul>
                                </div>
	...
	function ToForm(){
		document.forms['myform'].elements['ValeurNote'].value=count;
