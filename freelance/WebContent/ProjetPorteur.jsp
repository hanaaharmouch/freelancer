						...
						<div class="col-md-10 text-right menu-1">
								...
								<li class="has-dropdown">
									...
									<ul class="dropdown">
										...
										<li><a href="offres.php">Dernières offres</a></li>
					...
					<div >
						<div class="event-entry">
							<div class="desc">
								...
								<h3>Freelancer: <span>${p.nomf} ${p.prenomf}</span></h3>
								<td class='select1'><a class='button1' href="profilf.php?id=${p.id_freelancer}">Voir Profil</a></td>
								<td class='select1'><a class='button1' href="ValiderProjet?id=${p.id_projet}">Valider le projet</a></td>
