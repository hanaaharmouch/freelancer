        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Editer Offre ${offre.id}</h2>
                </div>
                <div class="card-body">
                
                    <form action="updateOffre.php?idp=${sessionScope.user_session.id}" method="POST">
                     <div class="form-row">
                            <div class="name">ID </div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="id" value="${offre.id}"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="projet" value="${offre.projet}"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="number" name="budget" value="${offre.budget}"/>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row row-refine">
                                    ...
                                    <div class="col-9">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="dure" value="${offre.dure}"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row m-b-55">
                            ...
                            <div class="value">
                                <div class="row row-refine">
                                    ...
                                    <div class="col-9">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="categorie" value="${offre.categorie}"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            <button class="btn btn--radius-2 btn--red" name="action" type="submit" value="updateOffre" >Editer</button>
                        </div>
                    </form>
                </div>
            </div>
