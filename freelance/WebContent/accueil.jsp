...
<html>
	...
	<title>Freelancer freelancer</title>
		...
		<nav class="colorlib-nav" role="navigation">
			...
			<div class="top-menu">
				<div class="container">
					<div class="row">
						<div class="col-md-2">
							<div id="colorlib-logo"><a href="index.html">Freelancer</a></div>
						</div>
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   			...
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Trouver votre freelancer</h1>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
			   	</li>
			   	<li style="background-image: url(images/art.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
			   	...
			   	<li style="background-image: url(images/trad.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-8 col-sm-12 col-md-offset-2 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h1>Redaction et traduction</h1>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
