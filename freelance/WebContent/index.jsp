                ...
                <div class="card-body">
                    <form action="controleur.php" method="POST" >
                                ...
                                <div class="row row-space">
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="prenom" value="${model.freelancer.prenom}">
                                            <label class="label--desc">Prenom</label>
                                        </div>
                                    </div>
                                    <div class="col-2">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="nom" value="${model.freelancer.nom}">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="adresse" value="${model.freelancer.adresse}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="radio" name="sexe" value="Féminim">Féminim
                                    <input class="input--style-5" type="radio" name="sexe" value="Masculin">Masculin
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="mail" value="${model.freelancer.mail}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="password" name="mdp" value="${model.freelancer.mdp}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <button class="btn btn--radius-2 btn--red" name="action" type="submit" value="savef" >Enregitrer</button>
                        </div>
                    </form>
                </div>
            </div>
