        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    ...
                    <form action="postuler.php?id=${O.id}&np=${O.projet}&idf=${sessionScope.user_session.id}&nomf=${sessionScope.user_session.nom}&prenomf=${sessionScope.user_session.prenom}" method="POST">
                                ...
                                <div class="row row-refine">
                                    ...
                                    <div class="col-9">
                                        <div class="input-group-desc">
                                            <textarea class="input--style-5" type="text" name="motivation" value="${model1.postulation.motivation}"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
