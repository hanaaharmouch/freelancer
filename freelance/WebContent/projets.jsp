					...
					<div class="row">
						...
						<div class="col-md-10 text-right menu-1">
							<ul>
								...
								<li class="btn-cta"><a href="connexion.jsp"><span>SE DECONNECTER</span></a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<table>
							<thead>
								<tr class="row100 head">
									<th class="cell100 column3">Projet</th>
									<th class="cell100 column3">Projet</th>
									<th class="cell100 column3">Catégorie</th>
									<th class="cell100 column2">Durée</th>
									<th class="cell100 column2">Budget</th>
									<th class="cell100 column1">POSTULATIONS</th>
									<th class="cell100 column1">EDITION </th>
									<th class="cell100 column1">SUPPRESSION</th>
						...
						<table>
							<tbody>
								<tr class="row100 body">
									<td class="cell100 column3">${p.id}</td>
									<td class="cell100 column3">${p.projet}</td>
									<td class="cell100 column3">${p.categorie}</td>
									<td class="cell100 column2">${p.dure}</td>
									<td class="cell100 column2">${p.budget} dhs</td>
									<td class="cell100 column1"><a href="Postulationp?id=${p.id}&idp=${sessionScope.user_session.id}"><button type="button">Postulations</button></a></td>
									<td class="cell100 column1"><a href="updateOffre.php?id=${p.id}&idp=${sessionScope.user_session.id}"><button type="button">Modifier</button></a></td>
									<td class="cell100 column1"><a href="DeleteOffre.php?id=${p.id}"><button type="button">Supprimer</button></a></td>
								</tr>
							</tbody>
						</table>
					</div>
